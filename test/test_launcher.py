...
class TestBetterLaunchExamples(unittest.TestCase):
    ...
    def assertTalkerListenerRunning(self, talker: Node, listener: Node, topic: str = "/test/better_launch/chatter") -> bool:
        time.sleep(2.0)
    ...
    def test_topic(self):
        ...
        sub = bl.subscriber("/test/better_launch/string", msg_type, callback=on_msg, qos_profile=qos_profile_parameters)
        
        time.sleep(1.0)
        
        bl.publish_message(
            "/test/better_launch/string", msg_type, {"data": "hello world"}, qos_profile=qos_profile_parameters
        )
    ...
    def test_node(self):
        ...
        talker = bl.node(
            ...
            "my_talker",
            remaps={"topic": "/test/better_launch/chatter"},
        )
        listener = bl.node(
        ...
        talker.start()
        listener.start()
        self.assertTalkerListenerRunning(talker, listener)
    ...
    def test_compose(self):
        ...
        with bl.compose("my_composer"):
            talker = bl.component(
                ...
                "composition::Talker",
                "comp_talker",
                remaps={"chatter": "/test/better_launch/chatter"},
            )
    ...
    def test_ros2_actions(self):
        ...
        ros2 = bl.ros2_actions(
            RosLaunchNode(
                ...
                name="my_talker",
                remappings=[("topic", "/test/better_launch/chatter")],
            ),
            RosLaunchNode(
